...
public class SortingJSON {
    ...
    private static String today=LocalDate.now().minusDays(1).toString();
    private static List<String>coursesFromLastWeek=new ArrayList<String>();
    ...
    private static String currentCourse() {
        ...
        for (int i = 0; i < rates.length(); i++) {
            ...
            if(object.getString("effectiveDate").equals(today)){
