...
public enum CurrencyAllType {
    ...
    private String currencyAllType;

    private CurrencyAllType(String currencyAllType) {
        this.currencyAllType = currencyAllType;
    }

    private String getCurrencyAllType() {
        return currencyAllType;
    }

    public static CurrencyAllType fromValue(String s) {
        for (CurrencyAllType type : values()) {
            if (type.getCurrencyAllType().equals(s)) {
                return type;
            }
        }
        return null;
